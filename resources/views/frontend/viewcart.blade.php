...
<head>
    <meta charset="utf-8">
    <title>Nest - Best Electronic and Electrical</title>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{route('frontcatshow')}}">Home</a>
            ...
            @if(\Session::has('error'))
                ...
                <div class="col-lg-8 mb-40">
                    ...
                    <div class="d-flex justify-content-between">
                        <h6 class="text-body">There are <span class="text-brand">{{ count(Cart::getContent()) }}</span> products in your cart</h6>
            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                ...
                                <tr class="pt-30">
                                    ...
                                    <td class="image product-thumbnail pt-40 pl-20"><img src="{{asset('backend/items/'.$view->attributes->img)}}" alt="#"></td>
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">{{  $view->name }}</a></h6>
                                    ...
                                    <td class="price" data-title="Price">
                                        <h4 class="text-body">${{ $view->price }}</h4>
                                    </td>
                                    <td class="text-center detail-info" data-title="Stock">
                                        <div class="detail-extralink mr-15">
                                            <div class="detail-qty border radius">
                                                <span class="qty-val">{{ $view->quantity }}</span>
                                                
                                            </div>
                                        </div>
                                    </td>
                                    <td class="price" data-title="Price">
                                        <h4 class="text-brand">${{ $view->price*$view->quantity }}</h4>
                                    </td>
                                    <td class="action text-center" data-title="Remove"><a href="{{ Route('itemDelete', $view->id) }}" class="text-body"><i class="fi-rs-trash"></i></a></td>
                                </tr>
                                @endforeach
                    ...
                    <div class="cart-action d-flex justify-content-between">
                        <a href="{{ Route('frontcatshow') }}" class="btn "><i class="fi-rs-arrow-left mr-10"></i>Continue Shopping</a>
                ...
                <div class="col-lg-4">
                    <div class="border p-md-4 cart-totals ml-30">
                            ...
                            <table class="table no-border">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart_total_amount">
                                            <h5 class="text-heading text-end">USA</h5></td> </tr> <tr>
                                        <td scope="col" colspan="2">
                                            <div class="divider-2 mt-10 mb-10"></div>
                                        </td>
                                    </tr>
                        ...
                        @if(Auth::check())
                        <button type="submit" href="#" class="btn mb-20 w-100 mt-2">Confirm Order</button>
                        @else
                        <span class="text-danger">Please login to confirm order</span>
                        <button disabled type="submit" href="#" class="btn mb-20 w-100 mt-2">Confirm Order</button>
                        @endif


                        </form>
                    </div>
                    <div class="payment ml-30 mt-4">
                        <h4 class="mb-10">Online Payment</h4>
                        <div class="payment-logo d-flex mb-2">
                        ...
                        <form action="{{ Route('processPaypal') }}" method="post">
                             ...
                             <input type="hidden" name="total" value="{{ $viws }}">
                        <button type="submit" href="#" class="btn mb-20 w-100 mt-10">Pay Online</button>
                           </form>
                    </div>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="{{asset('frontend')}}/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6310020f06232d0610174d000c0e">[email&#160;protected]</a></span></li>
