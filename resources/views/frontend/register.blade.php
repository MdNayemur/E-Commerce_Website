...
<head>
    <meta charset="utf-8">
    <title>Nest- Best Electronics & Electrical</title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Already have an account? <a href="{{ route('ulogin') }}">Login</a></p>
                                        </div>
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                            <x-input id="role" class="form-control" placeholder="Enter role" type="hidden" name="role" :value="3" required />
                                           ...
                                           <div class="flex items-center justify-end mt-4 form-group">
                                             <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('ulogin') }}">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="{{asset('frontend')}}/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ccbfada0a98c82a9bfb8e2afa3a1">[email&#160;protected]</a></span></li>
