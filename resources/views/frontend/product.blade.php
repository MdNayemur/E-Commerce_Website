...
<head>
    <meta charset="utf-8">
    <title>Nest - Best Electronic & Electrical store</title>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="{{route('frontcatshow')}}">Home</a>
                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('backend/items/'.$product->pic) }}" alt="product image">
                                        </figure>
                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">${{$product->disPrice}}</span>
                                            <span>
                                               
                                                <span class="old-price font-md ml-15">${{$product->salePrice}}</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">{{$product->des}}</p>
                                    </div>
                                  
                                   
                                    <div class="font-xs">
                                        <ul class="mr-50 float-start">
                                            <li class="mb-5">Type: <span class="text-brand">Grocery</span></li>
                                            <li class="mb-5">MFG:<span class="text-brand"> Jun 4.2023</span></li>
                                            <li>LIFE: <span class="text-brand">00 days</span></li>
                                        </ul>
                                        <ul class="float-start">
                                            <li class="mb-5">SKU: <a href="#">FWM15VKT</a></li>
                                            <li class="mb-5">Tags: <a href="#" rel="tag">mart</a>, <a href="#" rel="tag">fresh</a>, <a href="#" rel="tag">New</a></li>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="{{asset('frontend')}}/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="394a58555c79775c4a4d175a5654">[email&#160;protected]</a></span></li>
