...
<head>
    <meta charset="utf-8">
    <title>Nest- Best Electronics & Electrical shop</title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Don't have an account? <a href="{{ route('uregister') }}">Create here</a></p>
                                        </div>
                                           <!-- Session Status -->
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="{{asset('frontend')}}/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ef9c8e838aafa18a9c9bc18c8082">[email&#160;protected]</a></span></li>
